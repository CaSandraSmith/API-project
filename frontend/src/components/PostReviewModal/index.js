    ...
    return (
        <div className="post-review-modal-wrapper">
            ...
            <form className="review-form">
                ...
                <div className="rating-stars-input-wrapper">
                ...
                <button className="submit-review-button" onClick={handleSubmit} disabled={checkReview()}>Submit Your Review</button>
            </form>
        </div>
    )
}